...
export async function createNewSales(
  ...
  // const jsonTransactionItem = formData.get("transactionItem");
  // if (!jsonTransactionItem) throw new Error("ไม่พบรายการ");
  // const transactionItem = JSON.parse(jsonTransactionItem);
